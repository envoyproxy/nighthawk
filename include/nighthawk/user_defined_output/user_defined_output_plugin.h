...
public:
   ...
   * plugin.   
  */
  virtual UserDefinedOutputPluginPtr createUserDefinedOutputPlugin(const Envoy::Protobuf::Message& typed_config, const WorkerMetadata& worker_metadata) PURE;
   ...
   * @param global_output Any object to pack the aggregated output into to add to the global Result.
   * @return absl::Status
   */
  virtual absl::Status AggregateGlobalOutput(absl::Span<const google::protobuf::Any> per_worker_outputs, google::protobuf::Any& global_output_any) PURE;
};
}  // namespace Nighthawk