...
The update process can be completed by manually executing the steps documented on this [page]( https://github.com/envoyproxy/nighthawk/blob/main/docs/root/updating_envoy_dependency.md) **or** running a utility script. The rest of this page provides instructions for using the utility script.
