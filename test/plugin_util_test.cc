...
public:
  std::string name() const override { return "test-input-variable-setter"; }
...
public:
  std::string name() const override { return "test-scoring-function"; }
  Envoy::ProtobufTypes::MessagePtr createEmptyConfigProto() override {
    return std::make_unique<Envoy::ProtobufWkt::Any>();
  }
...
public:
  std::string name() const override { return "test-metrics-plugin"; }
  Envoy::ProtobufTypes::MessagePtr createEmptyConfigProto() override {
    return std::make_unique<Envoy::ProtobufWkt::Any>();
  }
...
public:
  std::string name() const override { return "test-step-controller"; }
  Envoy::ProtobufTypes::MessagePtr createEmptyConfigProto() override {
    return std::make_unique<Envoy::ProtobufWkt::Any>();
  }
...
// Creates an Any wrapping a LinearScoringFunctionConfig for use in the |typed_config| of all test
...
TEST(PluginUtilTest, CreatesCorrectInputVariableSetterType) {
  nighthawk::adaptive_load::InputVariableSetterConfig config;
  config.set_name("test-input-variable-setter");
...
TEST(PluginUtilTest, CreatesCorrectScoringFunctionType) {
  ...
  config.set_name("test-scoring-function");
  *config.mutable_typed_config() = CreateTypedConfigAny(0.0);
...
TEST(PluginUtilTest, CreatesCorrectMetricsPluginType) {
  ...
  config.set_name("test-metrics-plugin");
  *config.mutable_typed_config() = CreateTypedConfigAny(0.0);
...
TEST(PluginUtilTest, CreatesCorrectStepControllerType) {
  ...
  config.set_name("test-step-controller");
  *config.mutable_typed_config() = CreateTypedConfigAny(0.0);
