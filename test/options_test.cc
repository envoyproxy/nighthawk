...
TEST_F(OptionsImplTest, TunnelModeHInvalidProtocolCombination) {
  ...
  EXPECT_THROW_WITH_REGEX(
    TestUtility::createOptionsImpl(fmt::format(
        "{} {} --protocol http3 --tunnel-protocol http1 --tunnel-uri http://foo/", client_name_, good_test_uri_)),
...
TEST_F(OptionsImplTest, TunnelModeMissingParams) {
  ...
  EXPECT_THROW_WITH_REGEX(
    TestUtility::createOptionsImpl(fmt::format(
        "{} {} --protocol http1 --tunnel-protocol http1", client_name_, good_test_uri_)),
  ...
  EXPECT_THROW_WITH_REGEX(
    TestUtility::createOptionsImpl(fmt::format(
        "{} {} --protocol http1 --tunnel-tls-context {}", client_name_, good_test_uri_, tls_context)),
  ...
  EXPECT_THROW_WITH_REGEX(
      TestUtility::createOptionsImpl(fmt::format(
          "{} {} --protocol http2 --tunnel-protocol http3 --tunnel-uri http://foo/", client_name_, good_test_uri_)),
