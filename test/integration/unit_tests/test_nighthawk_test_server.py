...
[warning][runtime] Warning2 bar.
  ...
  warnings, errors = nighthawk_test_server._extractWarningsAndErrors(process_output, "test_case", ignore_list)
  assert not warnings
...
[warning][runtime] Warning2 bar.
  ...
  warnings, errors = nighthawk_test_server._extractWarningsAndErrors(process_output, "test_case1", ignore_list)
