...
function do_asan() {
    ...
    run_bazel build ${BAZEL_TEST_OPTIONS} -c dbg --build_tests_only --config=clang-asan -- //source/exe/...
    run_bazel build ${BAZEL_TEST_OPTIONS} -c dbg --build_tests_only --config=clang-asan -- //source/server/...
    run_bazel build ${BAZEL_TEST_OPTIONS} -c dbg --build_tests_only --config=clang-asan -- //test/mocks/...
    run_bazel build ${BAZEL_TEST_OPTIONS} -c dbg --build_tests_only --config=clang-asan -- //test/...
