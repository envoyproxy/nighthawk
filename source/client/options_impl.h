...
public:
  ...
  std::vector<envoy::config::metrics::v3::StatsSink> envoyStatsSinks() const override {
    return envoy_stats_sinks_;
  }
...
private:
  ...
  std::vector<envoy::config::metrics::v3::StatsSink> envoy_stats_sinks_;
