 ...
 */
class BinaryScoringFunctionConfigFactory : public virtual ScoringFunctionConfigFactory, public virtual NullConfigValidator {
public:
 ...
 * Registered as an Envoy plugin.
 */
class LinearScoringFunctionConfigFactory : public virtual ScoringFunctionConfigFactory, public virtual NullConfigValidator {
public:
  std::string name() const override;
  Envoy::ProtobufTypes::MessagePtr createEmptyConfigProto() override;
  ScoringFunctionPtr createScoringFunction(const Envoy::Protobuf::Message& message) override;
