...
bazel run @envoy//tools:code_format/check_format.py -- \
  ...
  --include_dir_order envoy,nighthawk,external/source/envoy,external,api,common,source,exe,server,client,distributor,grpcpp,request_source,test_common,test \
  $1 $TO_CHECK
