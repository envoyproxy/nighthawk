...
EXCLUDE="--exclude=../benchmarks/tmp/*,*/venv/*,../tools/gen_compilation_database.py,../bazel-*"
...
flake8 ../ ${EXCLUDE} --docstring-convention pep257 --ignore=E114,E111,E501,F401,F811 --count --show-source --statistics
